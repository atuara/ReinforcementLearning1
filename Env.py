...
class CabDriver_New():
    ...
    def update_time_day(self, time, day, ride_duration):
        ...
        if (time + ride_duration) < 24:
            ...
            number_of_days = (time + ride_duration) // 24
            
            # Convert the day to 0-6 range
            day = (day + number_of_days ) % 7
    ...
    def next_state_func(self, state, action, Time_matrix):
        ...
        next_state1 = [next_loc, next_time, next_day]
        
        return next_state1, wait_time, transit_time, ride_time
